<div class="max-w-7xl mx-auto px-4">
    ...
    <div class="flex justify-around dark:bg-gray-900 overflow-hidden  p-3 rounded-lg">
        <div class="bg-white dark:bg-gray-800 rounded-md shadow-lg   h-24 w-48 ">
            <a wire:navigate.hover  href="{{url(app()->getLocale().'/Emp'.'/'.$ids.'/Compt/Honhoraire') }}" class="h-full w-full">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-md shadow-lg  h-24 w-48 ">
            <a  wire:navigate.hover  href="{{url(app()->getLocale().'/Emp'.'/'.$ids.'/Compt/Paiements') }}" class="h-full w-full">
                <div class="  w-full  flex  ">
                    <div class=" h-full  w-full">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-md shadow-lg   h-24 w-48 ">
            <a  wire:navigate.hover href="{{url(app()->getLocale().'/Emp'.'/'.$ids.'/Compt/Remises') }}" class="h-full w-full">
                <div class="  w-full  flex  ">
                    <div class=" h-full  w-full">
