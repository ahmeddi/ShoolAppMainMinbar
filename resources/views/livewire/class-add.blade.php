                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1 col-span-2 w-full">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels">{{ __('classe.class-nom') }}:</label>
                    ...
                    <div class="flex flex-col space-y-1 col-span-2 w-full">
                      <div class="flex justify-between">
                          <label for="eid"  class="labels">{{ __('classe.class-res') }}:</label>
                        @error('moy') <span class="danger">{{ $message }}</span> @enderror  
                      </div>
                      ...
                      <div class="flex flex-col space-y-1 col-span-2 w-full">
                          <div class="flex justify-between">
                            <label   class="labels">{{ __('classe.class-prix') }}:</label>
                            @error('prix') <span class="danger">{{ $message }}</span> @enderror  
                          </div>
                          <input wire:model.defer='prix' class="inputs w-full col-span-2 @error('prix') reds @enderror" type="text"   required  />       
                      </div>

                      <div class="flex flex-col space-y-1 col-span-2 w-full">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('classe.soir') }}:</label>
                          @error('soir') <span class="danger">{{ $message }}</span> @enderror  
                        </div>
                        <input wire:model.defer='soir' class="inputs w-full col-span-2 @error('soir') reds @enderror" type="text"   required  />       
                      </div>
